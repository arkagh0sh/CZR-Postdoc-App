...
These data domains come in many forms.
The two most common examples of data domains that appear in the literature are:
%
\begin{enumerate}
...
In \cite{BKL11,BKL14}, the intuitive understanding of finite up to isomorphism has been formalised by the notion of orbit-finiteness.
...
who introduced \emph{set theory with atoms (ZFA)} and used \emph{permutation models} to show that the independence of axiom of choice in this setting
\cite{jech}.
This was rediscovered by Gabbay and Pitts as \emph{nominal sets},
...
This was also independently rediscovered in the concurrency community in terms of \emph{named sets},
...
and by Aschenbrenner, Hillar for their usefulness in chemistry and algebraic statistics \cite{AH04}.
...
%
\arka{with infinitely many variables?}
%
